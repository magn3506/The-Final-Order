...
if(isset($_GET['classroom_id'])
    ...
    // GET CLASSROOM DATA
    $get_classroom_api = 'http://127.0.0.1/The-Final-Order/private/api/classrooms/get-classroom.php?classroom_id='.$classroom_id;
    ...
    if(!is_object(json_decode($s_classroom_data))){
        ...
        $get_lectures_api = 'http://127.0.0.1/The-Final-Order/private/api/lectures/get-lectures-from-classroom-id.php?classroom_id='.$classroom_id;
